...
function Details({ accesorio }) {
  ...
  const handleAddToCart = () => {
    addToCart({ accesorio, quantity: qty });
    ...
    <>
      <div className="grid grid-cols-4">
        <div className="flex">
          ...
          {accesorio?.extraImages?.map((image) => (
      ...
      <div className="grid grid-cols-2 py-4">
        <div className="flex items-center px-1">
          <h1 className="text-2xl pr-36">{accesorio?.name}</h1>
          <span className="text-2xl text-right">{accesorio?.price} €</span>
        </div>
      ...
      <div className="grid grid-cols-2 py-6">
        <div className="px-1 ">
          <h1 className="font-mono text-xs pr-36">Ref: {accesorio?.ref} </h1>
        </div>
